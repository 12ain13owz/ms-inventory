...
_PageNotFoundComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PageNotFoundComponent, selectors: [["app-page-not-found"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 0, consts: [[1, "error-box"], ["routerLink", "/", "mat-raised-button", "", "color", "primary"], ["src", "assets/images/404.png", "alt", "404"]], template: function PageNotFoundComponent_Template(rf, ctx) {
  if (rf & 1) {
...
}, dependencies: [CoreModule, MatAnchor, RouterLink] });
var PageNotFoundComponent = _PageNotFoundComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PageNotFoundComponent, { className: "PageNotFoundComponent", filePath: "src\\app\\core\\components\\page-not-found\\page-not-found.component.ts", lineNumber: 12 });
})();

// src/app/core/components/server-error/server-error.component.ts
var _ServerErrorComponent = class _ServerErrorComponent {
  constructor() {
    this.route = inject(ActivatedRoute);
    this.router = inject(Router);
    this.http = inject(HttpClient);
    this.loadingScresnSergvice = inject(LoadingScreenService);
    this.toastr = inject(ToastNotificationService);
    this.apiUrl = environment.localhost + "health";
  }
  ngOnInit() {
    ...
    const delayConnect = 3e3;
    const maxRetry = 10;
    this.http.get(this.apiUrl, { responseType: "text" }).pipe(delay(delayConnect), retry({ count: maxRetry, delay: delayConnect })).subscribe(() => this.router.navigate(["/"]));
  }
  checkhealth(redirected) {
    this.loadingScresnSergvice.setIsLoading(true);
    this.http.get(this.apiUrl, { responseType: "text" }).pipe(catchError((error) => {
      if (!redirected)
        this.toastr.error("500", "Internal Server Error!");
      return throwError(() => error);
    }), finalize(() => this.loadingScresnSergvice.setIsLoading(false))).subscribe(() => this.router.navigate(["/"]));
  }
};
_ServerErrorComponent.\u0275fac = function ServerErrorComponent_Factory(t) {
  return new (t || _ServerErrorComponent)();
};
_ServerErrorComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServerErrorComponent, selectors: [["app-server-error"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 0, consts: [[1, "error-box"], ["color", "warn"], ["src", "assets/images/error-icon.png", "alt", "error-icon"]], template: function ServerErrorComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "h1", 1);
    \u0275\u0275text(2, "500");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h3");
    \u0275\u0275text(4, "Internal Server Error");
    \u0275\u0275elementEnd();
    \u0275\u0275element(5, "img", 2);
    \u0275\u0275elementEnd();
  }
}, dependencies: [HttpClientModule] });
var ServerErrorComponent = _ServerErrorComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ServerErrorComponent, { className: "ServerErrorComponent", filePath: "src\\app\\core\\components\\server-error\\server-error.component.ts", lineNumber: 16 });
})();
...
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-J4U3D3YN.js").then((m) => m.DashboardModule)
  },
  {
    path: "login",
...
var errorInterceptor = (req, next) => {
  ...
  return next(req).pipe(catchError((error) => {
    ...
    const message = status === 0 || status === 500 ? "Internal Server Error!" : error.error.message || "Unknown Error!";
    ...
    if (expired && error.status === 401) {
      ...
      return authService.refreshToken().pipe(switchMap((res) => {
        ...
        const authReq = authRequest.clone({
          headers: authRequest.headers.set("Authorization", `Bearer ${res.accessToken}`)
        });
        return next(authReq);
      }), catchError((error2) => EMPTY), finalize(() => isRefreshToken = false));
    }
    return throwError(() => error);
  }));
};
...
var th_default = ["th", [["a", "p"], ["\u0E01\u0E48\u0E2D\u0E19\u0E40\u0E17\u0E35\u0E48\u0E22\u0E07", "\u0E2B\u0E25\u0E31\u0E07\u0E40\u0E17\u0E35\u0E48\u0E22\u0E07"], u], [["\u0E01\u0E48\u0E2D\u0E19\u0E40\u0E17\u0E35\u0E48\u0E22\u0E07", "\u0E2B\u0E25\u0E31\u0E07\u0E40\u0E17\u0E35\u0E48\u0E22\u0E07"], u, u], [["\u0E2D\u0E32", "\u0E08", "\u0E2D", "\u0E1E", "\u0E1E\u0E24", "\u0E28", "\u0E2A"], ["\u0E2D\u0E32.", "\u0E08.", "\u0E2D.", "\u0E1E.", "\u0E1E\u0E24.", "\u0E28.", "\u0E2A."], ["\u0E27\u0E31\u0E19\u0E2D\u0E32\u0E17\u0E34\u0E15\u0E22\u0E4C", "\u0E27\u0E31\u0E19\u0E08\u0E31\u0E19\u0E17\u0E23\u0E4C", "\u0E27\u0E31\u0E19\u0E2D\u0E31\u0E07\u0E04\u0E32\u0E23", "\u0E27\u0E31\u0E19\u0E1E\u0E38\u0E18", "\u0E27\u0E31\u0E19\u0E1E\u0E24\u0E2B\u0E31\u0E2A\u0E1A\u0E14\u0E35", "\u0E27\u0E31\u0E19\u0E28\u0E38\u0E01\u0E23\u0E4C", "\u0E27\u0E31\u0E19\u0E40\u0E2A\u0E32\u0E23\u0E4C"], ["\u0E2D\u0E32.", "\u0E08.", "\u0E2D.", "\u0E1E.", "\u0E1E\u0E24.", "\u0E28.", "\u0E2A."]], u, [["\u0E21.\u0E04.", "\u0E01.\u0E1E.", "\u0E21\u0E35.\u0E04.", "\u0E40\u0E21.\u0E22.", "\u0E1E.\u0E04.", "\u0E21\u0E34.\u0E22.", "\u0E01.\u0E04.", "\u0E2A.\u0E04.", "\u0E01.\u0E22.", "\u0E15.\u0E04.", "\u0E1E.\u0E22.", "\u0E18.\u0E04."], u, ["\u0E21\u0E01\u0E23\u0E32\u0E04\u0E21", "\u0E01\u0E38\u0E21\u0E20\u0E32\u0E1E\u0E31\u0E19\u0E18\u0E4C", "\u0E21\u0E35\u0E19\u0E32\u0E04\u0E21", "\u0E40\u0E21\u0E29\u0E32\u0E22\u0E19", "\u0E1E\u0E24\u0E29\u0E20\u0E32\u0E04\u0E21", "\u0E21\u0E34\u0E16\u0E38\u0E19\u0E32\u0E22\u0E19", "\u0E01\u0E23\u0E01\u0E0E\u0E32\u0E04\u0E21", "\u0E2A\u0E34\u0E07\u0E2B\u0E32\u0E04\u0E21", "\u0E01\u0E31\u0E19\u0E22\u0E32\u0E22\u0E19", "\u0E15\u0E38\u0E25\u0E32\u0E04\u0E21", "\u0E1E\u0E24\u0E28\u0E08\u0E34\u0E01\u0E32\u0E22\u0E19", "\u0E18\u0E31\u0E19\u0E27\u0E32\u0E04\u0E21"]], u, [["\u0E01\u0E48\u0E2D\u0E19 \u0E04.\u0E28.", "\u0E04.\u0E28."], u, ["\u0E1B\u0E35\u0E01\u0E48\u0E2D\u0E19\u0E04\u0E23\u0E34\u0E2A\u0E15\u0E01\u0E32\u0E25", "\u0E04\u0E23\u0E34\u0E2A\u0E15\u0E4C\u0E28\u0E31\u0E01\u0E23\u0E32\u0E0A"]], 0, [6, 0], ["d/M/yy", "d MMM y", "d MMMM G y", "EEEE\u0E17\u0E35\u0E48 d MMMM G y"], ["HH:mm", "HH:mm:ss", "H \u0E19\u0E32\u0E2C\u0E34\u0E01\u0E32 mm \u0E19\u0E32\u0E17\u0E35 ss \u0E27\u0E34\u0E19\u0E32\u0E17\u0E35 z", "H \u0E19\u0E32\u0E2C\u0E34\u0E01\u0E32 mm \u0E19\u0E32\u0E17\u0E35 ss \u0E27\u0E34\u0E19\u0E32\u0E17\u0E35 zzzz"], ["{1} {0}", u, u, u], [".", ",", ";", "%", "+", "-", "E", "\xD7", "\u2030", "\u221E", "NaN", ":"], ["#,##0.###", "#,##0%", "\xA4#,##0.00", "#E0"], "THB", "\u0E3F", "\u0E1A\u0E32\u0E17", { "AUD": ["AU$", "$"], "BYN": [u, "\u0440."], "PHP": [u, "\u20B1"], "THB": ["\u0E3F"], "TWD": ["NT$"], "USD": ["US$", "$"], "XXX": [] }, "ltr", plural];

// src/app/app.config.ts
registerLocaleData(th_default);
var provideDateLocale = [{ provide: LOCALE_ID, useValue: "th-TH" }];
var jwtConfig = {
...
// src/app/core/animations/animation.ts
...
// src/app/core/components/loading-screen/loading-screen.component.ts
function LoadingScreenComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
...
var _LoadingScreenComponent = class _LoadingScreenComponent {
  constructor() {
    ...
    this.loadingScreenService = inject(LoadingScreenService);
    this.isLoading = false;
  }
  ngOnInit() {
    this.subscription = this.loadingScreenService.onIsLoadingListener().subscribe((isLoading) => this.isLoading = isLoading);
  }
  ngOnDestroy() {
    this.subscription.unsubscribe();
  }
};
_LoadingScreenComponent.\u0275fac = function LoadingScreenComponent_Factory(t) {
  return new (t || _LoadingScreenComponent)();
};
_LoadingScreenComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoadingScreenComponent, selectors: [["app-loading-screen"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 1, vars: 1, consts: [[1, "app-loading"], ["src", "assets/images/logo-bsru.png", "alt", "logo"], ["viewBox", "25 25 50 50", 1, "spinner"], ["cx", "50", "cy", "50", "r", "20", "fill", "none", "stroke-width", "2", "stroke-miterlimit", "10", 1, "path"]], template: function LoadingScreenComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, LoadingScreenComponent_Conditional_0_Template, 4, 1, "div", 0);
  }
  if (rf & 2) {
    \u0275\u0275conditional(0, ctx.isLoading ? 0 : -1);
  }
}, data: { animation: [FadeInOut(200, 200, true)] } });
var LoadingScreenComponent = _LoadingScreenComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoadingScreenComponent, { className: "LoadingScreenComponent", filePath: "src\\app\\core\\components\\loading-screen\\loading-screen.component.ts", lineNumber: 14 });
})();

// src/app/app.component.ts
var _AppComponent = class _AppComponent {
  constructor() {
    this.title = "msbsru-stock-it";
  }
};
_AppComponent.\u0275fac = function AppComponent_Factory(t) {
  return new (t || _AppComponent)();
};
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 0, consts: [[1, "fade-in"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-loading-screen");
    \u0275\u0275elementStart(1, "div", 0);
    \u0275\u0275element(2, "router-outlet");
    \u0275\u0275elementEnd();
  }
}, dependencies: [RouterOutlet, LoadingScreenComponent], styles: ["\n\n.fade-in[_ngcontent-%COMP%] {\n  animation: _ngcontent-%COMP%_fadeIn 0.3s;\n}\n@keyframes _ngcontent-%COMP%_fadeIn {\n  0% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n/*# sourceMappingURL=app.component.css.map */"] });
