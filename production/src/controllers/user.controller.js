...
function forgotPassworController(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const from = config_1.config.get("mailer").user;
            user.passwordResetCode = passwordResetCode;
            user.passwordExpired = new Date(createdAt.getTime() + 1000 * 60 * 60 * 1);
            const pathTemplate = (0, path_1.join)(__dirname, "../templates/email-template.html");
            ...
            yield user.save();
            const info = yield (0, mailer_1.sendEmail)(payload);
            if (!info)
